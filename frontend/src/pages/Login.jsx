...
import { Mail, Lock, Link2, ArrowRight, AlertCircle, Loader2, CheckCircle2 } from "lucide-react";
...
export default function Login() {
  ...
  // Note: Changed property name to 'Icon' (capitalized) to treat it as a component
  const socials = [
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-16">
          <div className="max-w-md">
            <h1 className="text-6xl font-extrabold leading-[1.1] text-white mb-8 tracking-tight">
              Control every <br />
              <span className="bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">click you share.</span>
            </h1>
            
            <div className="space-y-6 mb-12">
              {[
                { title: "Smart Shortening", desc: "Instant redirects with zero lag." },
                { title: "Permanent Storage", desc: "Stored Forever and use Anytime" },
                { title: "Total Control", desc: "Edit or delete links anytime." }
              ].map((item, i) => (
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-24">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-10 text-left">
            ...
            <p className="mt-3 text-slate-400">Welcome back! Please enter your details.</p>
          </div>
          ...
          <p className="mt-10 text-center text-slate-500">
            New to Shortenly?{" "}
            <Link to="/register" className="font-bold text-white hover:text-indigo-400 transition-colors underline decoration-indigo-500/30 underline-offset-4">
              Create an account
            </Link>
          </p>
        </div>
